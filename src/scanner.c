 ...
 */
void *tree_sitter_madlib_external_scanner_create() {
 ...
 */
bool tree_sitter_madlib_external_scanner_scan(void *indents_v, TSLexer *lexer, const bool *syms) {
 ...
 * copied.
 */
unsigned tree_sitter_madlib_external_scanner_serialize(void *indents_v, char *buffer) {
  indent_vec *indents = (indent_vec*) indents_v;
 ...
 */
void tree_sitter_madlib_external_scanner_deserialize(void *indents_v, char *buffer, unsigned length) {
  indent_vec *indents = (indent_vec*) indents_v;
 ...
 * Destroy the state.
 */
void tree_sitter_madlib_external_scanner_destroy(void *indents_v) {
  indent_vec *indents = (indent_vec*) indents_v;
  VEC_FREE(indents);
  free(indents);
}
