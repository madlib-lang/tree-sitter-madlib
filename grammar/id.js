...
module.exports = {
  ...
  _type_operator: ($) => alias(token("type"), $.type_operator),
  qualified_type_operator: ($) =>
    // qualified($, alias($._tyconsym, $.type_operator)),
    qualified($, alias(token("type"), $.type_operator)),
  ...
  type_literal: ($) => choice($.integer, $.string),
